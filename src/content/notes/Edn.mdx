---
title: EDN - The beautiful config format no one uses
description: In the midst of JSON-YAML Spaghetti, there's a relatively unknown format called EDN. It's beautiful.
...
:::note
Taken from [`cts`](https://github.com/rustdevbtw/cts)
:::
:::note
The above code wouldn't automatically get highlighted by [`expressive-code`](https://expressive-code.com).  
I use a custom TextMate Grammer for EDN to have it highlighted.
:::
...
6. Git Integration: EDN's structured format lends itself well to version control systems like Git, allowing for clear and manageable diffs and merges.
...
One example of me using EDN directly, is at [`cts`](https://github.com/rustdevbtw/cts).
